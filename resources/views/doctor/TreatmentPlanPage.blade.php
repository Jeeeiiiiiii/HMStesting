    ...
    <div class="bg-white rounded-lg shadow-md w-full max-w-4xl">
        ...
        <div class="p-6">
            ...
            <div class="mb-4">
                ...
                <p class="bg-gray-50 text-sm text-gray-600 py-2 px-4 rounded-md w-full">{{ $patient->test->hpi }}</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="bg-gray-50 text-sm text-gray-600 py-2 px-4 rounded-md w-full">{{ $patient->test->chief_complaint }}</p>
            </div>
