...
<div class="p-6">
    <div class="grid grid-cols-1 lg:grid-cols-1 gap-6">
        ...
        <div class="bg-white border border-gray-200 shadow-md p-6 rounded-lg overflow-x-auto mt-4">
            ...
            <div class="mb-6">
                <div class="text-lg font-semibold text-gray-800">Admin Information</div>
                <hr class="my-2 border-gray-300">
                <div class="space-y-4">
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Name</div>
                        <div class="font-bold text-xl">{{ $admin->name }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Age</div>
                        <div class="font-bold text-xl">{{ $admin->profile->age }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Gender</div>
                        <div class="font-bold text-xl">{{ $admin->profile->gender }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-4">
                    <div class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="font-bold text-xl">{{ $admin->email }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Contact Number</div>
                        <div class="font-bold text-xl">{{ $admin->profile->telephone_no }}</div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div class="flex flex-col md:flex-row md:items-center">
                        ...
                        <div class="font-bold text-xl">{{ $admin->profile->birthday }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Birthplace</div>
                        <div class="font-bold text-xl">{{ $admin->profile->birthplace }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Religion</div>
                        <div class="font-bold text-xl">{{ $admin->profile->religion }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Nationality</div>
                        <div class="font-bold text-xl">{{ $admin->profile->nationality }}</div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center">
                        <div class="w-full md:w-52 font-medium text-gray-700">Civil Status</div>
                        <div class="font-bold text-xl">{{ $admin->profile->civil_status }}</div>
                    </div>
                </div>
            </div>
        </div>
