    ...
    <div class="grid grid-cols-1 gap-6 mb-6">
        <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
            ...
            <div class="flex flex-col sm:flex-row justify-between sm:items-center mb-4 gap-4 sm:gap-0">
                <form action="{{ route('admin_emergencyroom') }}" method="GET" class="flex w-full sm:w-auto items-center">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="py-2 px-4 border-b border-gray-200">
                                <div class="flex gap-2">
                                    ...
                                    <form action="{{ route('users.delete', ['userType' => 'department', 'id' => $emergencyroom->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this department?')">
                                        @csrf
                                        @method('DELETE')
