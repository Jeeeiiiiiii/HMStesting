    ...
    <div class="bg-white rounded-lg shadow-md w-full max-w-4xl">
        ...
        <div class="p-6">
            ...
            <div class="mb-4">
                ...
                <p class="bg-gray-50 text-sm text-gray-600 py-2 px-4 rounded-md w-full">{{ $patient->order_status }}</p>
            </div>
...
function openModal(modalId, patientRecordId) {
    ...
    if (modal) {
        ...
        if (qrCodeImg) {
            ...
            fetch(`/emergencyroom/order/qr-code/${patientRecordId}`) // Update the endpoint URL as necessary
