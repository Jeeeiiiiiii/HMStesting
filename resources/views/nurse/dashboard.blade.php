                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b border-gray-50">
                                <div class="flex flex-wrap gap-2">
                                    <a href="{{ route('nurse_detailspatient', $record->patient->id) }}" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 transition duration-200">Details</a>
                                    <a href="{{ route('nurse_addpatient', $record->patient->id) }}" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 transition duration-200">Add Charts</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
